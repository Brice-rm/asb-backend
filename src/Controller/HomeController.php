...
class HomeController extends AbstractController
{
    ...
    public function index(request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {   // verifie que mon formulaire est été soumis et si il est valide
            ...
            $this->addFlash('notice', 'Merci de nous avoir contacté.'); // Notification de validation
            ...
            $mail = new Mail();
            $mail->send('bricerome77@gmail.com', 'ASB', 'Vous avez reçus une nouvelle demande de contact', $content);
